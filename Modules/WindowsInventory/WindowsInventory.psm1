...
function Get-WindowsInventoryLog 
{
  ...
  {
    Write-Output -InputObject $([System.IO.Path]::ChangeExtension([IO.Path]::GetTempFileName(),'txt')).ToString()
  }
}
...
function Get-WindowsInventory 
{
  ...
  process {
    ...
    Find-IPv4Device @ParameterHash |
    Where-Object {
      $_.IsWmiAlive -eq $true -or $_.IsWinRmAlive -eq $true
    } |
    Group-Object -Property WmiMachineName |
    ForEach-Object {
      $WmiDevice += $_.Group[0]
    }
    ...
    $ScriptBlock = {
      ...
      IF ($WinRM)
      {
          Get-WindowsMachineInformation -AdditionalData $AdditionalData -ComputerName $ComputerName -StopAtErrorCount $StopAtErrorCount -Type CIM
      }
      Else {
            Get-WindowsMachineInformation -AdditionalData $AdditionalData -ComputerName $ComputerName -StopAtErrorCount $StopAtErrorCount -Type WMI
      }
    ...
    $WmiDevice | ForEach-Object {
      ...
      IF ($_.IsWinRMAlive -eq $true)
      {
        $PowerShell = $PowerShell.AddArgument($_.DNSRecordName)
      }
      Else 
      {
      ...
      IF ($_.IsWinRMAlive -eq $true)
      {
        $PowerShell = $PowerShell.AddArgument($true)
      } #Set WinRM to True
        ...
        if ($Title) 
        {
          ...
          if ($CacheInRegistry) 
          {
            try 
            {
              ...
              $null = New-ItemProperty -Name ($_.ToUpper()) -Value $Title -Path $HotFixRegistryPath -PropertyType String -Force
            }
            catch 
            {
              # Do nothing
...
function Export-WindowsInventoryToExcel 
{
  ...
  process {
    ...
    # Get Hotfix titles
    $HotfixId = ($WindowsInventory.Machine |
      ForEach-Object {
        $_.Software.Patches 
      } |
      ForEach-Object {
    ...
    try 
    {
      ...
      $WindowsInventory.Machine | ForEach-Object {
        ...
        $WorksheetData[$Row, $Col++] = (
          $_.Hardware.Storage.DiskDrive |
          ForEach-Object {
            $_.Partitions |
            ForEach-Object {
              $_.LogicalDisks |
              Select-Object -Property Caption, SizeBytes
            }
          } |
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.Hardware.MotherboardControllerAndPort.PhysicalMemory 
      ...
      $Row = 1
      $WindowsInventory.Machine |
      Where-Object {
        $_.Hardware.MotherboardControllerAndPort.Processor.Name 
      } |
      ForEach-Object {
        $Col = 0
        $WorksheetData[$Row, $Col++] = $_.OperatingSystem.Settings.ComputerSystem.Name
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.Hardware.Storage.TapeDrive | Where-Object {
              $_.Name 
            } 
      }) | Measure-Object).Count + 1
      $ColumnCount = 4
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.Hardware.VideoAndMonitor.VideoController 
      }) | Measure-Object).Count + 1
      $ColumnCount = 4
      $WorksheetData = New-Object -TypeName 'string[,]' -ArgumentList $RowCount, $ColumnCount
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.OperatingSystem.Network.IPV4RouteTable 
      }) | Measure-Object).Count + 1
      $ColumnCount = 9
      $WorksheetData = New-Object -TypeName 'string[,]' -ArgumentList $RowCount, $ColumnCount
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.OperatingSystem.Settings.PowerPlan 
      }) | Measure-Object).Count + 1
      $ColumnCount = 5
      $WorksheetData = New-Object -TypeName 'string[,]' -ArgumentList $RowCount, $ColumnCount
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.OperatingSystem.Settings.StartupCommands 
      }) | Measure-Object).Count + 1
      $ColumnCount = 4
      $WorksheetData = New-Object -TypeName 'string[,]' -ArgumentList $RowCount, $ColumnCount
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.OperatingSystem.RunningProcesses 
      }) | Measure-Object).Count + 1
      $ColumnCount = 5
      $WorksheetData = New-Object -TypeName 'string[,]' -ArgumentList $RowCount, $ColumnCount
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.OperatingSystem.Users.LocalGroups 
      }) | Measure-Object).Count + 1
      $ColumnCount = 3
      $WorksheetData = New-Object -TypeName 'string[,]' -ArgumentList $RowCount, $ColumnCount
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.OperatingSystem.Users.LocalUsers 
      }) | Measure-Object).Count + 1
      $ColumnCount = 9
      $WorksheetData = New-Object -TypeName 'string[,]' -ArgumentList $RowCount, $ColumnCount
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.OperatingSystem.Users.DesktopSessions 
      }) | Measure-Object).Count + 1
      $ColumnCount = 10
      $WorksheetData = New-Object -TypeName 'string[,]' -ArgumentList $RowCount, $ColumnCount
      ...
      $RowCount = (($WindowsInventory.Machine | ForEach-Object {
            $_.Software.InstalledApplications 
      }) | Measure-Object).Count + 1
      $ColumnCount = 5
      $WorksheetData = New-Object -TypeName 'string[,]' -ArgumentList $RowCount, $ColumnCount
      ...
      $Range = $Worksheet.Range($Worksheet.Cells.Item(1,1), $Worksheet.Cells.Item($RowCount,$ColumnCount))
      $Range.Value2 = $WorksheetData
      $null = $Range.Sort($Worksheet.Columns.Item(1), $XlSortOrder::xlAscending, $Worksheet.Columns.Item(3), $MissingType, $XlSortOrder::xlAscending, $Worksheet.Columns.Item(2), $XlSortOrder::xlAscending, $XlYesNoGuess::xlYes)
