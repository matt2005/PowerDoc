...
function Get-BIOSCharacteristic($BIOSCharacteristic) 
{
  Write-Output -InputObject $(
    switch ($BIOSCharacteristic) {
      ...
      24 
      {
        '13h - 3.5 / 720 KB Floppy Services are supported'
      }
      25 
      {
...
function Get-ProcessorFamily($ProcessorFamily) 
{
  Write-Output -InputObject $(
    switch ($ProcessorFamily) {
      ...
      131 
      {
        'AMD Athlon(TM) 64 Processor Famiily'
      }
      132 
      {
      ...
      176 
      {
        'Pentium III Xeon(TM) Processor'
      }
      177 
      {
        'Pentium III Processor with Intel SpeedStep(TM) Technology'
      }
      178 
      {
        'Pentium 4'
...
function Get-OSInfo([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_OperatingSystem = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_OperatingSystem -Property Name, CSDVersion, InstallDate, OSLanguage, Version, WindowsDirectory -ComputerName $Computer
    }
  }
  ...
  $Win32_OperatingSystem | ForEach-Object -Process {
    ...
    $OSInfo.psobject.Properties | ForEach-Object -Process {
...
function Get-BIOSInfo([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_BIOS = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_BIOS -Property BiosCharacteristics, SMBIOSBIOSVersion, SMBIOSMajorVersion, SMBIOSMinorVersion, Version -ComputerName $Computer
    }
  }
  # This call should only bring back 1 row but just in case there are more we'll iterate through and make the last one the winner
  $Win32_BIOS | ForEach-Object -Process {
    ...
    $BIOSInfo.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  }
  Write-Output -InputObject $BIOSInfo
...
function Get-SystemInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_ComputerSystem = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_ComputerSystem -Property Domain, DomainRole, Name, NumberOfProcessors, TotalPhysicalMemory -ComputerName $Computer
    }
  }

  $Win32_ComputerSystem | ForEach-Object -Process {
    switch ($_.DomainRole) {
      0 
      {
  ...
  $SystemInformation.psobject.Properties | ForEach-Object -Process {
    Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
  }

  Write-Output -InputObject $SystemInformation
...
function Get-CDROMInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_CDROMDrive = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_CDROMDrive -Property Drive, Manufacturer, Name -ComputerName $Computer
    }
  }
  ...
  ForEach-Object -Process {
    ...
    $CDROMDrive.psobject.Properties |
    ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  }
  Write-Output -InputObject $CDROMInformation
...
function Get-ComputerSystemProductInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_ComputerSystemProduct = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_ComputerSystemProduct -Property Vendor, Name, IdentifyingNumber, Version -ComputerName $Computer
    }
  }

  # This call should only bring back 1 row but just in case there are more we'll iterate through and make the last one the winner
  $Win32_ComputerSystemProduct | ForEach-Object -Process {
    ...
    $ComputerSystemProductInformation.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  }
  Write-Output -InputObject $ComputerSystemProductInformation
...
function Get-DiskInformation([string]$Computer, [System.Version]$OSVersion, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_DiskDrive = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_DiskDrive -Property Caption, DeviceID, Interfacetype, Size -ComputerName $Computer
    }
  }
  ...
  $Win32_DiskDrive | ForEach-Object -Process {
    ...
    $Drive.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_DiskPartition = Get-CimInstance -Namespace root\CIMV2 -Query "Associators of {Win32_DiskDrive.DeviceID=""$DeviceID""} WHERE ResultClass = Win32_DiskPartition" -ComputerName $Computer
      }
    }
    ...
    ForEach-Object -Process {
      ...
      Switch ($Type){
        ...
        'CIM' 
        {
          $Win32_LogicalDisk = Get-CimInstance -Namespace root\CIMV2 -Query "Associators of {Win32_DiskPartition.DeviceID=""$PartitionDeviceID""} WHERE ResultClass = Win32_LogicalDisk" -ComputerName $Computer
        }
      }
      ...
      ForEach-Object -Process {
        ...
        if ($OSVersion.CompareTo($WindowsServer2003) -ge 0) 
        {
          try 
          {
            ...
            Switch ($Type){
              ...
              'CIM' 
              {
                $Win32_Volume = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Volume -Property BlockSize -Filter "DriveLetter = ""$($_.DeviceID)""" -ComputerName $Computer
              }
            }
        ...
        $LogicalDisk.psobject.Properties |
        ForEach-Object -Process {
  ...
  Write-Output -InputObject $DiskInformation
...
function Get-LocalGroupsInformation([string]$Computer, [System.Version]$OSVersion, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  if ($OSVersion.CompareTo($WindowsXP) -ge 0) 
  {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_Group = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Group -Property Name, Domain -Filter 'LocalAccount = True' -ComputerName $Computer
      }
    }
  }
  else 
  {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_Group = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Group -Property Name, Domain -Filter "(__SERVER = Domain) or (Domain = 'BUILTIN')" -ComputerName $Computer
      }
    }
  }
  ...
  ForEach-Object -Process {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_GroupUser = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_GroupUser -Property PartComponent -Filter "GroupComponent='Win32_Group.Domain=""$($_.Domain)"",Name=""$($_.Name)""'" -ComputerName $Computer
      }
    }

    $Win32_GroupUser |
    Sort-Object -Property PartComponent |
    ForEach-Object -Process {
      If (!$_.PartComponent) 
      {
        $User = 'UNKNOWN'
  ...
  Write-Output -InputObject $LocalGroupsInformation
...
function Get-IpRouteInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_IP4RouteTable = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_IP4RouteTable -Property Destination, Mask, NextHop, Metric1, Metric2, Metric3, Metric4, Metric5 -ComputerName $Computer
    }
  }
  $Win32_IP4RouteTable | ForEach-Object -Process {
    ...
    $Route.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  }
  Write-Output -InputObject $IpRouteInformation
...
function Get-DesktopSessionInformation([string]$Computer) 
{
  ...
  if ((Test-Path -Path 'function:Get-RDSession') -eq $true) 
  {
    try 
    {
      ...
      Get-RDSession -RDSHost $Computer | ForEach-Object -Process {
        ...
        $Session.psobject.Properties | ForEach-Object -Process {
          Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
        }
      }
    }
  ...
  Write-Output -InputObject $DesktopSession
...
function Get-NetworkAdapterConfig([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_NetworkAdapterConfiguration = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_NetworkAdapterConfiguration -Property Description, MACAddress, DNSHostName, DHCPEnabled, DHCPServer, DNSDomain, WINSPrimaryServer, WINSSecondaryServer, IPAddress, IPSubnet, DefaultIPGateway, DNSServerSearchOrder -Filter 'IPEnabled = True' -ComputerName $Computer
    }
  }

  $Win32_NetworkAdapterConfiguration | ForEach-Object -Process {
    ...
    $Adapter.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  }
  Write-Output -InputObject $NetworkAdapterConfig
...
function Get-EventLogSettings([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_NTEventLogFile = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_NTEventlogFile -Property LogFileName, MaxFileSize, Name, OverwritePolicy -ComputerName $Computer
    }
  }

  $Win32_NTEventLogFile | ForEach-Object -Process {
    ...
    $EventLog.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  }
  Write-Output -InputObject $EventLogSettings
...
function Get-PagefileInformation([string]$Computer, [System.Version]$OSVersion, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  if ($OSVersion.CompareTo($WindowsVista) -ge 0) 
  {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_ComputerSystem = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_ComputerSystem -Property AutomaticManagedPagefile -ComputerName $Computer
      }
    }
  ...
  if ($OSVersion.CompareTo($WindowsXP) -ge 0) 
  {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_PageFileUsage = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_PageFileUsage -Property AllocatedBaseSize, CurrentUsage, Name, PeakUsage, TempPageFile -ComputerName $Computer
      }
    }
  }
  else 
  {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_PageFileUsage = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_PageFileUsage -Property AllocatedBaseSize, CurrentUsage, Name, PeakUsage -ComputerName $Computer
      }
    }
  }
  ...
  ForEach-Object -Process {
    if ($AutomaticManagedPagefile -ne $true) 
    {
      ...
      Switch ($Type){
        ...
        'CIM' 
        {
          $Win32_PageFileSetting = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_PageFileSetting -Property MaximumSize -Filter "Name = '$($_.Name.Replace('"\"','"\\"'))'" -ComputerName $Computer
        }
      }
    ...
    $PageFile.psobject.Properties |
    ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    } 
  }
  Write-Output -InputObject $PagefileInformation
...
function Get-PhysicalMemoryInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_PhysicalMemory = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_PhysicalMemory -Property BankLabel, Capacity, DeviceLocator, FormFactor, HotSwappable, Manufacturer, MemoryType, PartNumber, SerialNumber, Speed, TypeDetail -ComputerName $Computer
    }
  }
  ...
  ForEach-Object -Process {
    ...
    $PhysicalMemory.psobject.Properties |
    ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  }
  Write-Output -InputObject $PhysicalMemoryInformation
}
...
function Get-PowerPlanInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  try 
  {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_PowerPlan = Get-CimInstance -Namespace root\CIMV2\power -ClassName Win32_PowerPlan -Property ElementName, Description, IsActive -ComputerName $Computer -ErrorAction Stop
      }
    }
  }
  catch 
  ...
  ForEach-Object -Process {
    ...
    $PowerPlan.psobject.Properties |
    ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  } 
  Write-Output -InputObject $PowerPlanInformation
...
function Get-PrinterInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  ForEach-Object -Process {
    ...
    $Printer.psobject.Properties |
    ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  }
  Write-Output -InputObject $PrinterInformation
...
function Get-ProcessInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_Process = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Process -ComputerName $Computer
    }
  }
  ...
  $Win32_Process | ForEach-Object -Process {
    ...
    $Process.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  } 
  Write-Output -InputObject $ProcessInformation
...
function Get-ProcessorInformation([string]$Computer, [System.Version]$OSVersion, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  ) 
  {
    ...
    if ($OSVersion.CompareTo($WindowsVista) -ge 0) 
    {
      ...
      Switch ($Type){
        ...
        'CIM' 
        {
          $Win32_Processor = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Processor -Property DataWidth, Description, ExtClock, Family, L2CacheSize, L2CacheSpeed, L3CacheSize, L3CacheSpeed, Manufacturer, MaxClockSpeed, Name, NumberOfCores, NumberOfLogicalProcessors, MaxClockSpeed, SocketDesignation -ComputerName $Computer
        }
      }
    }
    else 
    {
      ...
      Switch ($Type){
        ...
        'CIM' 
        {
          $Win32_Processor = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Processor -Property DataWidth, Description, ExtClock, Family, L2CacheSize, L2CacheSpeed, Manufacturer, MaxClockSpeed, Name, NumberOfCores, NumberOfLogicalProcessors, MaxClockSpeed, SocketDesignation -ComputerName $Computer
        }
      }
    }
    ...
    $NumberofPhysicalProcessors = @(@($Win32_Processor) |
      ForEach-Object -Process {
        $_.SocketDesignation
      } |
  ...
  else 
  {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_Processor = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Processor -Property DataWidth, Description, ExtClock, Family, L2CacheSize, L2CacheSpeed, Manufacturer, MaxClockSpeed, Name, MaxClockSpeed, SocketDesignation -ComputerName $Computer
      }
    }
  ...
  $ProcessorInformation.psobject.Properties | ForEach-Object -Process {
    Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
  } 

  Write-Output -InputObject $ProcessorInformation
...
function Get-ApplicationInformationFromWMI([string]$Computer, [System.Version]$OSVersion, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  try 
  {
    ...
    if ($OSVersion.CompareTo($WindowsVista) -ge 0) 
    {
      ...
      Switch ($Type){
        ...
        'CIM' 
        {
          $Win32_Product = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Product -Property Name, Vendor, Version, InstallLocation, InstallDate, InstallDate2, HelpLink, URLInfoAbout, URLUpdateInfo -Filter 'Name <> Null' -ComputerName $Computer -ErrorAction Stop
        }
      }
    } 
    elseif ($OSVersion.CompareTo($WindowsXP) -ge 0) 
    {
      ...
      Switch ($Type){
        ...
        'CIM' 
        {
          $Win32_Product = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Product -Property Name, Vendor, Version, InstallLocation, InstallDate, InstallDate2 -Filter 'Name <> Null' -ComputerName $Computer -ErrorAction Stop
        }
      }
    } 
    else 
    {
      ...
      Switch ($Type){
        ...
        'CIM' 
        {
          $Win32_Product = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Product -Property Name, Vendor, Version, InstallLocation, InstallDate -Filter 'Name <> Null' -ComputerName $Computer -ErrorAction Stop
        }
      }
    }
  }
  ...
  $Win32_Product | ForEach-Object -Process {
    ...
    $Application.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  } 

  Write-Output -InputObject $ApplicationInformation
...
function Get-RegistrySizeInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_Registry = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Registry -Property CurrentSize, MaximumSize -ComputerName $Computer
    }
  }

  # This call should only bring back 1 row but just in case there are more we'll iterate through and make the last one the winner
  $Win32_Registry | ForEach-Object -Process {
  ...
  $RegistrySizeInformation.psobject.Properties | ForEach-Object -Process {
    Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
  }

  Write-Output -InputObject $RegistrySizeInformation
...
function Get-ServicesInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_Service = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Service -Property Caption, PathName, Started, StartMode, StartName -Filter "ServiceType ='Share Process' Or ServiceType ='Own Process'" -ComputerName $Computer
    }
  }

  $Win32_Service |
  Sort-Object -Property Caption |
  ForEach-Object -Process {
  ...
  Write-Output -InputObject $ServicesInformation
...
function Get-ShareInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_Share = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Share -Property Name, Description, Path, Type -ComputerName $Computer
    }
  }
  ...
  ForEach-Object -Process {
    ...
    $Share.psobject.Properties |
    ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  } 
  Write-Output -InputObject $ShareInformation
...
function Get-SoundDeviceInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_SoundDevice = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_SoundDevice -Property Name, Manufacturer -ComputerName $Computer
    }
  }

  $Win32_SoundDevice | ForEach-Object -Process {
    ...
    $SoundDevice.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  } 
  Write-Output -InputObject $SoundDeviceInformation
...
function Get-StartupCommandInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_StartupCommand = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_StartupCommand -Property Command, Name, User -ComputerName $Computer
    }
  }

  $Win32_StartupCommand |
  Sort-Object -Property User, Name |
  ForEach-Object -Process {
    ...
    $StartupCommand.psobject.Properties |
    ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  } 
  Write-Output -InputObject $StartupCommandInformation
...
function Test-ServiceInstallState([string]$Computer, [string]$ServiceName, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  if (@(Switch ($Type){
        'WMI' 
        {
          Get-WmiObject -Namespace root\CIMV2 -Class Win32_Service -Filter "name='$ServiceName'" -ComputerName $Computer -ErrorAction SilentlyContinue
        }
        'CIM' 
        {
          Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_Service -Filter "name='$ServiceName'" -ComputerName $Computer -ErrorAction SilentlyContinue
        }
  }).Count -gt 0) 
  {
...
function Get-SystemEnclosureInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_SystemEnclosure = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_SystemEnclosure -Property ChassisTypes -ComputerName $Computer
    }
  }

  $Win32_SystemEnclosure | ForEach-Object -Process {
    $SystemEnclosureInformation = New-Object -TypeName psobject -Property @{
      ChassisType = Get-ChassisType($_.ChassisTypes)
    }
  } 

  $SystemEnclosureInformation.psobject.Properties | ForEach-Object -Process {
    Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t$($_.Name): $($_.Value)"
  }

  Write-Output -InputObject $SystemEnclosureInformation
...
function Get-TapeDriveInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_TapeDrive = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_TapeDrive -Property Name, Description, Manufacturer -ComputerName $Computer
    }
  }
  ...
  ForEach-Object -Process {
    ...
    $TapeDrive.psobject.Properties |
    ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  } 
  Write-Output -InputObject $TapeDriveInformation
...
function Get-TimeZoneInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_TimeZone = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_TimeZone -Property Description -ComputerName $Computer
    }
  }

  $Win32_TimeZone | ForEach-Object -Process {
    $TimeZoneInformation = New-Object -TypeName psobject -Property @{
      Description = $_.Description
    }
  }

  $TimeZoneInformation.psobject.Properties | ForEach-Object -Process {
    Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t$($_.Name): $($_.Value)"
  }

  Write-Output -InputObject $TimeZoneInformation
...
function Get-PatchInformationFromWMI([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  ForEach-Object -Process {
    ...
    $Patch.psobject.Properties |
    ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  } 
  Write-Output -InputObject $PatchInformation
...
function Get-UserAccountInformation([string]$Computer, [System.Version]$OSVersion, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  if ($OSVersion.CompareTo($WindowsXP) -ge 0) 
  {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_UserAccount = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_UserAccount -Property Description, Name, Disabled, FullName, Lockout, PasswordChangeable, PasswordExpires, PasswordRequired, PasswordRequired -Filter 'LocalAccount = True' -ComputerName $Computer
      }
    }
  }
  else 
  {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $Win32_UserAccount = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_UserAccount -Property Description, Name, Disabled, FullName, Lockout, PasswordChangeable, PasswordExpires, PasswordRequired, PasswordRequired -Filter '__SERVER = Domain' -ComputerName $Computer
      }
    }
  }

  $Win32_UserAccount | ForEach-Object -Process {
    ...
    $UserAccount.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  } 
  Write-Output -InputObject $UserAccountInformation
...
function Get-VideoControllerInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_VideoController = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_VideoController -Property AdapterCompatibility, AdapterRAM, Name -ComputerName $Computer
    }
  }

  $Win32_VideoController | ForEach-Object -Process {
    ...
    $VideoController.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  }
  Write-Output -InputObject $VideoControllerInformation
...
function Get-ServerFeatureInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_ServerFeature = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_ServerFeature -Property ID, Name, ParentID -ComputerName $Computer
    }
  }
  ...
  $Win32_ServerFeature | ForEach-Object -Process {
...
function Get-OptionalFeatureInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  Switch ($Type){
    ...
    'CIM' 
    {
      $Win32_OptionalFeature = Get-CimInstance -Namespace root\CIMV2 -ClassName Win32_OptionalFeature -Property Caption, Name, InstallState -ComputerName $Computer
    }
  }

  $Win32_OptionalFeature | ForEach-Object -Process {
    ...
    $OptionalFeature.psobject.Properties | ForEach-Object -Process {
      Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
    }
  } 
  Write-Output -InputObject $OptionalFeatureInformation
...
function Get-IIS6WebInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  $IISWebServer | ForEach-Object -Process {
    ...
    $IISWebServerSetting | ForEach-Object -Process {
      ...
      $_.ServerBindings | ForEach-Object -Process {
    ...
    $IIsWebVirtualDir | ForEach-Object -Process {
      ...
      $IIsWebVirtualDirSetting | ForEach-Object -Process {
  ...
  Write-Output -InputObject $IIS6WebInformation
...
function Get-IIS7WebInformation([string]$Computer, [ValidateSet('CIM','WMI')][String]$Type = 'WMI') 
{
  ...
  try 
  {
    ...
    Switch ($Type){
      ...
      'CIM' 
      {
        $IIS7Site = Get-CimInstance -Namespace root\WebAdministration -ClassName Site -Property Name, Bindings -Authentication PacketPrivacy -ComputerName $Computer
      }
    }
  }
  catch 
  ...
  $IIS7Site | ForEach-Object -Process {
    ...
    $IIS7Application | ForEach-Object -Process {
      $IIS7VirtualDir = $_.GetRelated('VirtualDirectory')

      $IIS7VirtualDir | ForEach-Object -Process {
        $VirtualDir = New-Object -TypeName psobject -Property @{
          Name     = $_.Name
          Settings = @()
        }
  ...
  Write-Output -InputObject $IIS7WebInformation
...
function Get-DomainInformation($RegistryProvider) 
{
  ...
  Write-Output -InputObject $DomainInformation
...
function Get-PrintSpoolLocation($RegistryProvider) 
{
  ...
  Write-Output -InputObject $PrintSpoolLocation
...
function Get-TerminalServerMode($RegistryProvider) 
{
  ...
  Write-Output -InputObject $TerminalServerMode
...
function Get-LastLoggedInUser($RegistryProvider) 
{
  ...
  Write-Output -InputObject $LastLoggedInUser
...
function Get-WindowsComponentInformation($RegistryProvider) 
{
  ...
  foreach ($RegValue in $RegItemCollection.sNames) 
  {
    ...
    if ($RegValue) 
    {
      ...
      $Component.psobject.Properties | ForEach-Object -Process {
        Write-WindowsMachineInformationLog -MessageLevel Debug -Message "`t`t$($_.Name): $($_.Value)"
      } 
    }
  }
  Write-Output -InputObject $WindowsComponentsInformation
...
function Get-WindowsMachineInformation 
{
  ...
  process {
    ...
    finally 
    {
      ...
      Write-Output -InputObject $MachineInformation
